...
/*
    ...
    float activa;
    //cout << "Las activaciones para ese neuron son: "<<activa<<endl;
    //cout << "Las activaciones derivativas para ese neuron son: "<<neu.getActivacionDerivativa()<<endl;
    Capa cap(3,3);
    //cap.neuronas[0].activaciones(inputs);
*/
     //LO QUE DEBERIA IR
    ...
    // inicializacion de entrada y salida
            ...
            nn_neurons[1] =2*3;// layer 2: hidden layer - 6 neurons
